...
This is a fork of the [Google API PHP Client][https://github.com/googleapis/google-api-php-client],
but with support for a previous (and currently deprecated) API with existing endpoints.
## Installation ##
...
```sh
composer require bshaffer/apiclient-mybusiness:^0.1
```
